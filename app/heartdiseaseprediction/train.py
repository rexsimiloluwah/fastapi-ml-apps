...
class HeartDiseaseModel:
    ...
    def train_model(self):
        ...
        model = RandomForestClassifier(
            max_depth=8, max_features="sqrt", n_estimators=900
        )
    ...
    def predict(self, data: dict):
        ...
        features = [
            ...
            data["cigsPerDay"],
            data["diaBP"],
            prevalence_enc[data["prevalentHyp"].lower()],
            diabetes_enc[data["diabetes"].lower()],
            bpmeds_enc[data["BPMeds"].lower()],
            male_enc[data["gender"].lower()],
            bmi,
            prevalence_enc[data["prevalentStroke"].lower()],
        ]
